...
obj={
        ...
        editOne:function (id) {
                ...
                $.ajax({
                	    url:bathPath+'/systemfunction/find',
                        type:'POST',
                        dataType:'json',
                        data: { 
                        	id:id
                        ...
                        success:function (data) {
                        	...
                        	$("#funcName").val(data.model.funcName);
                        	$("#funcDesc").val(data.model.funcDesc);
                        	$("#action").val(data.model.action);
                        }
                })
        },
        // 提交表单
        sum:function () {
        	    ...
        	    if(valid){
        	    	$.ajax({            
  	                  ...
  	                  url:bathPath+'/systemfunction/save',
               ...
               if(rows.length>0){
                       $.messager.confirm('确定删除','你确定要删除你选择的记录吗？',function (flg) {
                               if(flg){
                                      ...
                                      $.ajax({
                                              type:'post',
                                              url:bathPath+'/systemfunction/delete',
                                              data:{
                                                      ids:ids.join(';')
                                              },
                                              beforesend:function () {
