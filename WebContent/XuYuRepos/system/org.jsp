    ...
    <div data-options="region:'center',split:true">
        ...
        <div class="tableFind" data-options="region:'north',border:false" style="height:65px;">
            <form id="queryForm" method="post">
	            <p>
	               <label>机构名称:</label><input type="text" id="orgNameQuery"/>
...
<div id="addBox" >
    <form id="addForm" method="post">
        <!--  
        <div class="formDiv"><label>机构ID:</label><input type="text" name="orgId" id="orgId" class="easyui-validatebox" data-options="required:true"><span class="formSpan">*</span></div>-->
        <div class="formDiv"><label>机构名称:</label><input type="text" name="orgName"    style="width:335px" id="orgName" class="easyui-validatebox" data-options="required:true"><span class="formSpan">*</span></div>
        <div class="formDiv" id="yesNoDiv"><label>是否部门:</label><select  name="isDept" id="yesNo"   style="width:335px" prompt="请选择"  class="easyui-combobox" ></select><span class="formSpan">*</span></div>
        <div id="upOrgIdDiv" class="formDiv"><label>上级机构:</label><select  name="upOrgId" id="upOrgId" style="width:335px" prompt="请选择"  class=""easyui-combotree"></select></div>
