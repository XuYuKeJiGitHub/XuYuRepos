...
<div class="easyui-layout" data-options="fit:true" id="useBox">
    <div data-options="region:'center',split:true">
        <!--表格查询-->
        <div class="tableFind" data-options="region:'north',border:false" style="height:90px;">
              <form id="queryForm" method="post">
	             <p>
		            <label>套餐名称:</label><input type="text" name="comboName" id="comboNameQuery" class="easyui-validatebox">
		            <label>支付类型:</label><select  name="payType" id="payTypeQuery" editable="false" class="easyui-combobox"></select>
...
<div id="addBox" >
    <form id="addForm" method="post">
        <div class="formDiv"><label>套餐类型:</label><select  name="comboType" id="comboType"  style="width:368px" editable="false" class="easyui-combobox"></select></div>
        <div class="formDiv"><label>套餐:</label><select  name="comboName" id="comboName"  style="width:368px" editable="false" class="easyui-combobox"></select></div>
        ...
        <div class="formDiv"><label>支付类型:</label><select  name="payType" id="payType"  style="width:368px" editable="false" class="easyui-combobox"></select></div>
        <div class="formDiv"><label>沉默期类型:</label><select  name="silentType" id="silentType"  style="width:368px" editable="false" class="easyui-combobox"></select></div>
        <div class="formDiv"><label>测试期:</label><select  name="haveTest" id="haveTest"  style="width:368px" editable="false" class="easyui-combobox"></select></div>
        <div class="formDiv"><label>代理商:</label><input type="text" name="companyName" id="orgName" editable="false" class="easyui-validatebox" data-options="required:true"><a href="#" class="easyui-linkbutton" onclick="openOrg()">选择</a></div>
        <input type="text" hidden="true" id="orgId"  name="companyId" >
...
<script src=groupChoose.js></script>
