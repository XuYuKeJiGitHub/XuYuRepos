...
public class TelecomDesEncrypt {
    ...
    public static String sign(String[] strArray,String protal) {
        ...
        return strEnc(naturalOrdering(strArray), XuYuKey.shizhang_Des_key);
    	}else if(protal.equals("xiaolu")) {
            return strEnc(naturalOrdering(strArray), XuYuKey.xiaolu_Des_key);
    	}
    	return "";
    }
    ...
    public static String strEnc(String data,String key) {
        ...
        String firstKey=key.substring(0,3);
		String secondKey=key.substring(3,6);
		String thirdKey=key.substring(6,9);
