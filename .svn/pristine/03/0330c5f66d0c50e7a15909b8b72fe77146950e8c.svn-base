                ...
                $.ajax({
                    ...
                    data : {
                    	accessNum : $.trim($("#accessNumQuery").textbox('getValue')),
                  	    ...
                  	    orderStatus:$.trim($("#orderStatusQuery").combobox('getValue')),
                  	    tradeType:$.trim($("#tradeTypeQuery").combobox('getValue')),
       	   ...
       	   $.messager.confirm('提示信息','是否导出所有查询记录',function (flg) {
               if(flg){
               	    $.ajax({            
                         ...
                         url:basePath+'/xuyurecharge/exporCtustomerData',
                         beforeSend: function () {
                             $.messager.progress({
                                 title: '提示信息',
                                 msg: '系统正在导出数据，请稍候……',
