...
<%@page import="com.xuyurepos.entity.payment.PaymentOrder"%>
<%@page import="com.alipay.config.AlipayConfig"%>
<%@page import="com.alipay.core.AlipayCoreService"%>
<%@page import="com.alipay.util.UniqueOrderGenerate"%>
...
<script language="javascript">
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "旭宇科技充值套餐支付";
